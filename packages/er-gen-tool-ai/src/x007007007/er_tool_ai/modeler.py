...
from x007007007.er_tool_ai.prompts import get_er_modeling_prompt, get_error_feedback_prompt
from x007007007.er_tool_ai.validator import validate_toml_syntax, extract_toml_from_markdown
...
class ERModeler:
    ...
    def __init__(self, api_key: Optional[str] = None, base_url: Optional[str] = None):
        ...
        from x007007007.er_tool_ai.prompts import get_er_modeling_prompt_text
        ...
        from x007007007.er_tool_ai.prompts import get_refine_prompt
