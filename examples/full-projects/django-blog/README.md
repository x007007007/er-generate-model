...
这是一个完整的 Django 项目示例，展示如何使用 ER 转换工具导出和管理数据库模型。
...
此项目位于 `examples/full-projects/django-blog/`，是 examples 目录重构后的完整项目示例。
...
# 导出特定 app
uv run python manage.py er_export blog --format toml
```
